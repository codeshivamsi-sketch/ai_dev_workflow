...
slash_commands() {
  step "Slash commands (/arch, /blast, /db-blast, /docs-sync, /review) in .claude/commands/"
  ...
  install_tpl commands/docs-sync.md .claude/commands/docs-sync.md "/docs-sync created"
